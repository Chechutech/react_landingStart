...
function Footer() {
  return (
    <section className="bg-bgSecondary py-20 sm:px-16 px-6">
      <div className=" grid md:grid-cols-4 grid-cols-2 gap-6 px-5 ">
        <div className="order-last md:order-first">
          <img
            src={logoStartOK}
            alt="logo Startupz footer"
            className="w-[179px] h-[43px] object-contain"
          />
          <p className="text-primaryText text-xs mt-6">
            © 2020 Startupz.
            <br />
            All rights reserved.{" "}
          </p>
        ...
        <div className="ml-6">
          <h4 className="text-primaryText font-medium text-base ">Companies</h4>
          <ul className="text-actionColor text-lg font-normal py-3">
        ...
        <div className="ml-6">
          <h4 className="text-primaryText font-medium text-base ">Contact</h4>
          <ul className="text-actionColor font-normal py-3">
            <li className="cursor-pointer text-[#939393] text-sm">
        ...
        <div className="ml-6 2">
          <h4 className="text-primaryText font-medium text-base">Follow us</h4>
          <ul className="text-actionColor flex flex-col items-start py-3 gap-2 ">
            <li className="cursor-pointer ">
              <a href="#">
                <svg
                  width="23"
